        ...
        <div className='shadow-md w-full'>
            <div className="md:flex bg-gray-600 py-4 md:px-10 px-7 items-center justify-between">
                ...
                <ul className={`md:flex block md:items-center m-0 p-0 ${open ? '' : 'hidden'}`}>
                    <li className="ml-8 text-xl md:my-0 my-7"><Link to="/" className="flex items-center text-gray-800 hover:text-gray-400 duration-500"><HomeIcon className="mr-2" /> <span>HOME</span></Link></li>
                    <li className="ml-8 text-xl md:my-0 my-7"><Link to="/cart" className="flex items-center text-gray-800 hover:text-gray-400 duration-500"><ShoppingCartIcon className="mr-2" /> <span>CART</span></Link></li>
                    {userInfo ? (
                    ...
                    <li className="ml-8 text-xl md:my-0 my-7"><Link to="/login" className="flex items-center text-gray-800 hover:text-gray-400 duration-500"><PersonIcon className="mr-2" /> <span>LOGIN</span></Link></li> }
                </ul>
            </div>
        </div>
    )
